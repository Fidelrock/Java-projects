...
public class TeacherDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2,b3;
    JTextField t2;
    String x[] = {"Name","Father's Name","Age","Date of Birth","Address","Phone","Email",  "Other_No","Course","Department", "Employee Id"};
    ...
    TeacherDetails(){
        ...
        l1 = new JLabel("Enter employment ID to delete Teacher : ");
