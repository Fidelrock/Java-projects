...
//	}
        ...
        public AboutUs() {
            ...
            super("About Us - Telville State University");
        ...
        setVisible(true);
          JLabel l = new JLabel("New label");
           ...
           //contentPane.setResizeable(false);
            ...
            JLabel l6 = new JLabel("Developed By : YOUNG DEVELOPERS");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l8 = new JLabel("Contact : fidelisodhiambo254@gmail.com");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("Education - Telville (Computer Science)");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(70, 320, 600, 34);
            contentPane.add(l9);


            JLabel l10 = new JLabel("Phone - +254 769 607 323");
